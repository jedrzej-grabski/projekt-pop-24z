...
from src.projekt_pop_24z.benchmark_functions.ackley import Ackley
from src.projekt_pop_24z.benchmark_functions.cec import CEC2014_F1

ALL_FUNCS = (Sphere, Rosenbrock, Rastrigin, Ackley, CEC2014_F1)
