...
jego wartości. Wyniki znajdują się w tabeli \ref{tab:rosenbrock_values}.
...
\begin{table}[h]
	...
	\begin{tabular}{c|c c c c c}
		\hline
		Dynamiczny współczynnik bezwładności / $\omega_0$ & 0.05 & 0.1 & 0.2 & 0.4 & 0.7  \\
		\hline
...
Badanie było przeprowadzone dla różnych funkcji, jednak w innych wypadkach wyniki były do siebie znacznie bardziej zbliżone.
